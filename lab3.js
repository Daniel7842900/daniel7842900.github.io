...
function addFunction() {
	...
	var trArtistName = document.createTextNode(artistName);
	var trArtistAbout = document.createTextNode(artistAbout);

	pName.appendChild(trArtistName);
	pDesc.appendChild(trArtistAbout);
